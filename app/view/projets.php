...
<section class="py-5 bg-light" id="presentation-projets">
    <div class="container">
        ...
        <h3 class="fw-light">BTS SIO</h3>
        <h4 class="fw-light text-center">Introduction</h4>
        <p class="p-4 text-center">Le BTS Services informatiques aux Organisations est un diplôme reconnu par l’état de niveau Bac+2. Il remplace, depuis septembre 2011, l’ancien BTS informatique de Gestion (BTS IG). En effet, cette nouvelle formule répond aux attentes de la profession en matière de qualification. Le programme a évolué en fonction de la place et du rôle des TIC (Technologies d’Information Communication) et propose deux spécialités bien distinctes : le BTS SIO SISR et le BTS SIO SLAM.
        </p>
        <h4 class="fw-light text-center">L'option SLAM</h4>
        <div class="text-center">
            <p>L’option Solutions logicielles et applications métiers forme des spécialistes des logiciels (rédaction d’un cahier des charges, formulation des besoins et          spécifications, développement, intégration au sein de la société). Les techniciens supérieurs en informatique option SLAM, sont préparés aux métiers de :
                <ul>
