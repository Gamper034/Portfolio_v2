  <main>
      ...
      <section class="py-5" id="welcome">
          <div class="container">
              <h2 class="fw-bold">Présentation</h2>
                  ...
                  <div class="col-sm-12 col-md-7">
                      ...
                      <div class="p-3">
                          <div class="row align-items-center">
                              <div class="col-5 col-sm-4 col-lg-3 col-xl-2">
                                  <div class="d-flex align-items-center">
                                      <img src="files/img/jquery.png" alt="jquery icon" height="35px" class="me-2 ps-0">
                  ...
                  <div class="col-sm-12 offset-md-1 col-md-7">
                      ...
                      <div class="p-3 ">
                          <div class="row align-items-center">
                              <div class="col-5 col-sm-4 col-lg-3 col-xl-2">
                                  <div class="d-flex align-items-center">
                                      <i class="fa-brands fa-git-alt fa-2x me-3 text-orange"></i>
